...
module.exports = (SQS) => {
     ...
     */
    function SQSExt(options) {
        SQS.call(this, options);
     ...
     */
    SQSExt.prototype._parseReceiptHandle = function(receiptHandle = '', separator = RECEIPT_HANDLE_SEPARATOR) {
     ...
     */
    SQSExt.prototype._uploadToS3 = function({MessageBody} = {}, s3Key) {
        const params = {
     ...
     */
    SQSExt.prototype._messageToS3 = function(params) {
     ...
     */
    SQSExt.prototype._cloneWithReceiptHandleFromS3 = function(params) {
        const clone = cloneDeep(params);
     ...
     */
    SQSExt.prototype._deleteFromS3 = function({Entries, ReceiptHandle}) {
     ...
     */
    SQSExt.prototype._pruneFailedDeleteMessage = function(params, {Failed = []}) {
        const clone = cloneDeep(params),
     ...
     * @return {AWS.Request} - [AWS.Request]{@link https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/Response.html}.
     */
    SQSExt.prototype.sendMessage = function(params, callback) {
        ...
        if (
            ...
            const {mutatedParams, s3Key} = this._messageToS3(params),
                ...
                sqsRequest = SQSExt.super_.prototype.sendMessage.call(this, mutatedParams);
            ...
            return SQSExt.super_.prototype.sendMessage.call(this, params, callback);
        }
    };
    ...
    SQSExt.prototype.receiveMessage = function(params, callback) {
        const sqsRequest = SQSExt.super_.prototype.receiveMessage.call(this, params);
     ...
     * @return {AWS.Request} - [AWS.Request]{@link https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/Response.html}.
     */
    SQSExt.prototype.deleteMessage = function(params, callback) {
        let mutatedParams;
        ...
        const sqsRequest = SQSExt.super_.prototype.deleteMessage.call(this, mutatedParams);
     ...
     * @return {AWS.Request} - [AWS.Request]{@link https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/Response.html}.
     */
    SQSExt.prototype.deleteMessageBatch = function(params, callback) {
        let mutatedParams;
        ...
        const sqsRequest = SQSExt.super_.prototype.deleteMessageBatch.call(this, mutatedParams);
