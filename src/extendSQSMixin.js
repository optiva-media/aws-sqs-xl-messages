...
module.exports = (SQS) => {
    ...
    function SQSExt(options) {
        ...
        const SQSPrototype = Object.getPrototypeOf(this._client);

        for (const f in SQSPrototype) {
            if (Object.prototype.hasOwnProperty.call(SQSPrototype, f)) {
                if (f !== 'constructor' && !Object.keys(Object.getPrototypeOf(this)).includes(f) && typeof SQSPrototype[f] === 'function') {
